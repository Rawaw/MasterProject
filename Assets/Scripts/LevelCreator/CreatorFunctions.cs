...
public class CreatorFunctions : MonoBehaviour
{
    ...
    private void removeSpecialMark(Vector3Int position, Tilemap map){
        ...
        switch(map.GetTile(position).name){
                        case "Player": 
                            playerPosition = null;
                            Debug.Log("Removing player mark");
                            break;
                        case "Orb":
                            orbPosition = null;
                            Debug.Log("Removing orb mark");
                            break;
                        case "Glove":
                            glovePosition = null;
                            Debug.Log("Removing glove mark");
                            break;
                        case "Feather":
                            featherPosition = null;
                            Debug.Log("Removing feather mark");
                            break;
                        case "Boots":
                            bootsPosition = null;
                            Debug.Log("Removing boots mark");
                            break;
                        case "FinalDoor":
                            exitPosition = null;
                            Debug.Log("Removing door mark");
                            break;
                    }
    }
